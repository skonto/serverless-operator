...
replace (
	...
	knative.dev/eventing => github.com/openshift/knative-eventing v0.99.1-0.20220331153639-7d61d42f37a3
	knative.dev/eventing-kafka => github.com/openshift-knative/eventing-kafka v0.19.1-0.20220331121128-d72948ffaf32
	knative.dev/eventing-kafka-broker => github.com/openshift-knative/eventing-kafka-broker v0.25.1-0.20220405181748-900d13264c97
	knative.dev/pkg => knative.dev/pkg v0.0.0-20211210132429-e86584fd3c69
	knative.dev/serving => github.com/openshift/knative-serving v0.10.1-0.20220404132257-d5a850807e5b
)
